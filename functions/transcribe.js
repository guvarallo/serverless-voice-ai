exports.handler = function (context, event, callback) {
  ...
  if (!event.request.cookies.convo) {
    ...
    twiml.say(
      ...
      ',,,Olá! Eu sou a Stélla, um robô criado usando Twilio e Chat GêPêTê. Você pode perguntar qualquer coisa para mim, só espere um pouco depois da sua pergunta pra eu pensar direitinho na melhor resposta pra você, ok? Pode perguntar agora.'
    )
  }
